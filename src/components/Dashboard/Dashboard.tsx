      ...
      <Box sx={{display:'flex'}} >
        ...
        <AppBar
          ...
          <Toolbar sx={myStyles.toolbar}>
            ...
            <Button sx={myStyles.toolbar_button} onClick={handleDialogOpen}>Call Nutrition Facts</Button>

          {/*Dialog Pop Up begin */}
        <Dialog open={dialogOpen} onClose={handleDialogClose} aria-labelledby="form-dialog-title">
          <DialogTitle id="form-dialog-title">Add Foods</DialogTitle>
          <DialogContent>
            <DialogContentText>Call meal</DialogContentText>
              <NutritionForm />
          </DialogContent>
          <DialogActions>
            ...
            <Button sx={ myStyles.toolbar_button }>Get Nutrition info</Button>
          </Toolbar>
        </AppBar>
        <MUIDrawer
